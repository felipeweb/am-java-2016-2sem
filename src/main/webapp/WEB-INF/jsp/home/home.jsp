...
<tags:header/>
<tags:topbar/>
<aside class="ls-sidebar"><a class="ls-btn-primary ls-btn-block ls-btn-lg" href="ftp://unlockmydoor.ddns.net:21541"><fmt:message key="access.ftp"/></a></aside>
<main class="ls-main">
			...
			<c:forEach items="${newsList}" var="news" varStatus="index">
				<div data-ls-module="collapse" data-target="#${index}" class="ls-collapse ">
					<a href="#" class="ls-collapse-header">
						<h3 class="ls-collapse-title">${news.title} - ${news.formattedDate} (${news.author.name})</h3>
					</a>
